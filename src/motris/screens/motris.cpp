   ...
   , player_4("Player 4", 4)
{
   ...
   gamer_input_screen.player_input_configurations[player_2.get_player_num()].setup_default_joystick_mapping_for_XBOX_360_CONTROLLER();
}
...
void Motris::process_event(ALLEGRO_EVENT &event)
{
   ...
   case GAME_EVENT_GOTO_SINGLE_PLAYER_GAMEPLAY_SCREEN:
      ...
      break;
   case GAME_EVENT_GOTO_MULTIPLAYER_GAMEPLAY_SCREEN:
      {
