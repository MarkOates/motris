...
enum game_events
{
   ...
   SYSTEM_EVENT_GOTO_SINGLE_PLAYER_GAMEPLAY_SCREEN = ALLEGRO_GET_EVENT_TYPE('M','t','r','s'),
   SYSTEM_EVENT_GOTO_MULTIPLAYER_GAMEPLAY_SCREEN,
   SYSTEM_EVENT_GOTO_MAIN_MENU_SCREEN,
   ...
   MAIN_MENU_MOVE_SELECT_MENU_ITEM,
